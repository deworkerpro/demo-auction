...
final class CallbackTest extends WebTestCase
{
    ...
    {
        $this->oAuthMailRu()->initAuthFlow('code', '1111', 'new@app.test');

        $response = $this->app()->handle(self::html('GET', '/oauth/mailru?' . http_build_query([
            'code' => 'code',
            'state' => 'sTaTe',
        ])));
    ...
    {
        $this->oAuthMailRu()->initAuthFlow('code', '0000001', 'other@app.test');
    ...
    {
        $this->oAuthMailRu()->initAuthFlow('code', '1111', 'active@app.test');
    ...
    {
        $this->oAuthMailRu()->initAuthFlow('code', '1111', 'wait@app.test');
