...
final class Version20230912141953 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event_store_consumed_events (id BIGSERIAL NOT NULL, queue VARCHAR(255) NOT NULL, type VARCHAR(255) NOT NULL, event_id BIGINT NOT NULL, PRIMARY KEY(id))');
